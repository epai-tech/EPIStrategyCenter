...
{
    public class ATRGrid2:BaseIndicator
    {
        private int _length;
        private double _num;
        ...
        public ATRGrid2(List<BarData> bars, int length = 20, double num = 1.5, int theme = 1, bool isSimpleMode = true, bool isShowInMain = true, string tag = "1")
            : base(bars)
        {
            Tag = tag;
            _length = length;
            ...
            Name = string.Format("ATRGrid2{0}", paramTag);
            Description = "波动网格2";
        ...
        private void GenerateATRGrid(int i)
        {
            ...
            {
                upLineValue = curData.Close + _num * atrValue;
                downLineValue = curData.Close - _num * atrValue;
            }
            else
            {
